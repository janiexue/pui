...
function onLoad() {
    ...
    // update cart number //
    if (sessionStorage.getItem("cartNum") != null && sessionStorage.getItem("cartNum") != 0) {
    ...
    // update cart page with each line item; code inspired by https://www.youtube.com/watch?v=YeFzkC2awTM
